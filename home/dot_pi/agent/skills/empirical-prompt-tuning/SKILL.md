...
description: "Iteratively refine agent-facing prompts by dispatching fresh agents, scoring on two axes, and iterating until plateau. Use after authoring/revising skills, task prompts, AGENTS.md or CLAUDE.md sections, or when diagnosing instruction ambiguity. [Triggers: empirical prompt tuning, prompt evaluation, prompt tuning, skill evaluation, harden prompt, evaluate skill, tune prompt, fresh agent evaluation]"
---
