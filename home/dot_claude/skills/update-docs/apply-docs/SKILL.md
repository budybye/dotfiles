---
name: apply-docs
description: Skill for analyzing existing docs/ and AGENTS.md, then updating, reflecting, and fixing them to match the current codebase. Works via interactive dialogue (ask what changed) or auto-scan mode (detect drift between code and docs automatically). Covers all 7 docs/ files and AGENTS.md. [Triggers: /apply-docs, update docs, sync docs, fix docs, docs out of date, AGENTS.md outdated, reflect changes in docs, docs drift, documentation inconsistency, update AGENTS.md]
---

# /apply-docs — Documentation Sync & Update Skill
