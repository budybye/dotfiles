---
name: testcase
description: A skill for identifying, designing, and managing test cases — the planning phase before coding begins. Systematically identify test cases from conversations or context, and manage them using tests/testlist.md and tests/TDD.md. Use /tdd-cycle to execute the Red→Green→Refactor cycle once the test list is ready. [Triggers: /testcase, identify test cases, test design, test list, test priority, test strategy, test planning, what should I test]
---
