...
description: "Single entry for technology recommendations: judge scope, shortlist, then verify with docs and source. [Triggers: recommend research, technology choice, library comparison, stack evaluation, OSS research]"
---

# Recommend research

1. **Scope** — Multiple moving parts (stack, practice, integration across layers) → holistic evaluation. One category or one library family → narrow track.
