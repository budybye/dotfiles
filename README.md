...
- **予定**: `WSL2`（[計画あり](.cursor/plans/2025-02-19-wsl2-support.md)）、`Windows`、`FreeBSD` + jail
...
| ドキュメント                          | 説明                                                                                      |
| ------------------------------------- | ----------------------------------------------------------------------------------------- |
| [計画書](.cursor/plans/)              | 実装計画の一覧（`.cursor/plans/`）                                                      |
...
**AI 向けガイドライン**: [AGENTS.md](AGENTS.md)（Cursor 向け）、[CLAUDE.md](home/dot_claude/CLAUDE.md)（Claude 向け）

### クイックリンク

- [Makefile コマンド一覧](docs/design.md#makefile-設計)
- [Chezmoi コマンドリファレンス](docs/directory.md#コマンドリファレンス)
- [実装計画一覧（.cursor/plans/）](.cursor/plans/)
